package com.mariusbudin.hvor.core.functional

import com.mariusbudin.hvor.UnitTest
...
class EitherTest : UnitTest() {
    ...
    fun `Either Right should return correct type`() {
        val result = Either.Right("Success")
        ...
        result.fold({},
            { right ->
                ...
                right shouldEqualTo "Success"
            })
    }

    @Test
    fun `Either Left should return correct type`() {
        val result = Either.Left("Success")
